    ...
    const experiences = [
        {
            ...
            desc: 'Motion-first rebuild (GSAP/Framer) to 60fps across Flows; +20% conversion on primary funnels.',
            achievements: [
        ...
        },
        {
            company: 'CODEARRAYS',
            role: 'UI ENGINEER',
            period: '2021 — 2023 • Hybrid',
            desc: 'Built the core component library used across 5 different products, ensuring consistent design tokens.',
            achievements: [
                'Migrated legacy codebase to React 18 with zero downtime.',
                'Implemented automated accessibility testing pipeline.',
                'Mentored 3 junior developers.'
            ],
            stack: ['React', 'TypeScript', 'Storybook', 'Jest', 'Cypress']
        },
        {
            company: 'HYPERPLAY STUDIOS',
            role: 'WEB DEVELOPER',
            period: '2020 — 2021 • Remote',
            desc: 'Developed marketing sites for indie game launches with high-impact visuals.',
            achievements: [
                'Integrated WebGL backgrounds for immersive experience.',
                'Optimized asset delivery reducing load times by 40%.',
                'Built custom CMS for content management.'
            ],
            stack: ['Vue.js', 'Three.js', 'Node.js', 'MongoDB']
        },
        {
            company: 'SYNTHOS',
            role: 'JUNIOR DEV',
            period: '2019 — 2020 • On-site',
            desc: 'Backend maintenance and API development for internal tools.',
            achievements: [
                'Refactored legacy PHP scripts to modern Node.js services.',
                'Database schema optimization.',
                'Internal dashboard UI improvements.'
            ],
