    ...
    const projects = [
        {
            ...
            image: 'bg-gradient-to-br from-gray-900 to-black', // Placeholder for screenshot
        },
        {
            title: 'NEON COMMERCE',
        ...
        },
        {
            ...
            features: [
                ...
                'Low-latency websocket responses.'
            ],
                        ...
                        <div className="w-full md:w-1/2 flex flex-col justify-center">
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <button className="flex items-center gap-2 px-6 py-3 bg-white border-3 border-retro-dark rounded-lg font-display text-xs uppercase shadow-[4px_4px_0_0_#1f2937] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_#1f2937] transition-all w-fit group">
